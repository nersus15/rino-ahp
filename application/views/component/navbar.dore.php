    ...
    <div class="navbar-right">
        ...
        <div class="user d-inline-block">
            <button class="btn btn-empty p-0" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="name"><?php echo !empty(sessiondata('login', 'nama_lengkap')) ? sessiondata('login', 'nama_lengkap') : sessiondata('login', 'username') ?></span>
                <span>
                    <img alt="Profile Picture" src="<?php echo base_url('public/assets/img/profile/' . sessiondata('login', 'photo')) ?>" />
                </span>
            </button>
