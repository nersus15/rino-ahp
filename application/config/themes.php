...
$config['themes'] = array(
    ...
    'login' => array(
        'js' => array(
            array('type' => 'cdn', 'pos' => 'head', 'src' => assets_url('themes/login/vendor/animsition/js/animsition.min.js')),
            array('type' => 'cdn', 'pos' => 'head', 'src' => assets_url('themes/login/js/main.js'))

        ),
        'css' => array(
            array('type' => 'cdn','src' => assets_url('themes/login/fonts/iconic/css/material-design-iconic-font.min.css'), 'pos' => 'head'),
            array('type' => 'cdn','src' => assets_url('themes/login/vendor/animate/animate.css'), 'pos' => 'head'),
            array('type' => 'cdn','src'=> assets_url("themes/login/vendor/css-hamburgers/hamburgers.min.css"), 'pos' => 'head'),
            array('type' => 'cdn','src'=> assets_url("themes/login/vendor/animsition/css/animsition.min.css"), 'pos' => 'head'),
            array('type' => 'cdn','src'=> assets_url("themes/login/vendor/select2/select2.min.css"), 'pos' => 'head'),
            array('type' => 'cdn','src'=> assets_url("themes/login/vendor/daterangepicker/daterangepicker.css"), 'pos' => 'head'),
            array('type' => 'cdn','src'=> assets_url("themes/login/css/util.css"), 'pos' => 'head'),
            array('type' => 'cdn','src'=> assets_url("themes/login/css/main.css"), 'pos' => 'head'),
        ),
    )
);